export function buildReportText(analysis) {
  const lines = ['Clearline Crisis Report', `Pipeline: ${analysis.pipeline_type ?? 'common'}`, `Urgency: ${analysis.urgency ?? 'medium'}`, '', 'Plain Summary', analysis.plain_language_summary ?? ''];
